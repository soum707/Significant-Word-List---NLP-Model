...
if option == "Upload a File":
    ...
    preloaded_files = ["Alice In Wonderland", "Lord of the Rings - Chapter One", "Titanic (Movie Script)", "The Catcher In The Rye.txt", "The Great Gatsby.txt", "1984.txt", "Harry Potter And the Sorcerer’s Stone.txt"]
